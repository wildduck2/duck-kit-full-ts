...
//     }
//
// <<<<<<< HEAD:apps/acme-server/src/auth/__test__/auth.controller.test.ts
//     expect(() => {}).not.toThrow()
//   })
// =======
//     expect(() => {
...
//     }).not.toThrow();
//   });
// >>>>>>> 4fe3775 (test(auth): add tests for controller and service + restore AuthGuard):apps/document-server/src/auth/__test__/auth.controller.test.ts
//
//   /* ---------------------- signout ---------------------- */
